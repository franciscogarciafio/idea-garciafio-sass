...
const carritoIndex = (productoCarrito)=>{
    ...
    if((productoCarrito.stock <= 0) || (productoCarrito != undefined && producto.cantidad >= 
productoCarrito.stock)){
        Swal.fire({
            position: 'center',
            icon: 'info',
            width: 200,
            title: `Lo sentimos, por el momento el ${productoCarrito.nombre}, ya está recervada`,
...
validarCarrito ? (carritoDeCompras = JSON.parse(validarCarrito), hacerCarrito()) : 
carritoDeCompras = [];
